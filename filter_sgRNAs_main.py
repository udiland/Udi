...
def main(target_dir, threshold, threshold_distance, number_of_sgs, bottom_up, method, crispys_threshold, relative):   #target_dir must be the directory of all the families
    ...
    genome_data_path = os.path.join(MAIN_FILES_DIR, ORGANISM_SHORT_NAME+".con")
    ...
    annotation_file_source = os.path.join(MAIN_FILES_DIR, ORGANISM_SHORT_NAME+"_annotation.gff")
    pickle_genome_file_path = os.path.join(MAIN_FILES_DIR, ORGANISM_SHORT_NAME+ "_genome_dic.p")
    ...
    pickle_annotation_file_path = os.path.join(target_dir_annotation_file, ORGANISM_SHORT_NAME+ "_annotation.p")
    ...
    path_for_exons_dic = os.path.join(MAIN_FILES_DIR, ORGANISM_SHORT_NAME+ '_dict_exons.p')
